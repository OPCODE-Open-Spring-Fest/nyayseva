  ...
  return (
    ...
    <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
            ...
            <h1 className="mt-3 text-5xl font-semibold text-gray-800 dark:text-white ">Page not found</h1>
...
<Link to="/">
                <button className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-[chocolate] rounded-lg shrink-0 sm:w-auto  ">
                    Take me home
                </button>
                </Link>
            </div>
